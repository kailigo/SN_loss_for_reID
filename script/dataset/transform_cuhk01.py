...
def save_images(zip_file, save_dir=None, train_test_split_file=None):
  ...
  for dir_name in ['bounding_box_train', 'bounding_box_test', 'query']:
    ...
    # import pdb
    # pdb.set_trace()
    im_paths_ = get_im_names(osp.join(raw_dir, dir_name), pattern='*.png',
...
def old_main():
  ...
  parser.add_argument('--zip_file', type=str,
                      default='/export/reid_datasets/transformed_collection/cuhk01/test100/split_9')
...
if __name__ == '__main__':
  ...
  for i in range(9, 10):
    ...
    zip_file = '/export/reid_datasets/transformed_collection/cuhk01/test486/split_'+split_num
    save_dir = '/export/reid_datasets/transformed_collection/cuhk01/test486/split_'+split_num
