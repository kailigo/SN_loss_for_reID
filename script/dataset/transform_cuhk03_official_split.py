...
def save_images(zip_file, save_dir=None, train_test_split_file=None):
  ...
  for dir_name in ['bounding_box_train', 'bounding_box_test', 'query']:
    ...
    im_paths_ = get_im_names(osp.join(raw_dir, dir_name), pattern='*.jpg',
...
if __name__ == '__main__':
  ...
  for i in range(4, 20):
    split_num = str(i)
    zip_file = '/export/reid_datasets/transformed_collection/CUHK03/labeled/official_split/'+split_num
    save_dir = '/export/reid_datasets/transformed_collection/CUHK03/labeled/official_split/'+split_num

    # parser.add_argument('--zip_file', type=str,
    #                   default='/export/reid_datasets/transformed_collection/CUHK03/labeled/official_split/'+split_num)
    # parser.add_argument('--save_dir', type=str,
    #                   default='/export/reid_datasets/transformed_collection/CUHK03/labeled/official_split/'+split_num)
    # args = parser.parse_args()
    zip_file = osp.abspath(osp.expanduser(zip_file))
    save_dir = osp.abspath(osp.expanduser(save_dir))
