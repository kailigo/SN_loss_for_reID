...
class TrainSet(Dataset):
  ...
  def get_sample(self, ptr):
    ...
    # speedE2 = '{}'.format(speed)

    im_names = ['{}'.format(self.im_names[ind]) for ind in inds]

    # str(self.im_names[ind]) for ind in inds]
    # im_names = [str(self.im_names[ind], 'utf-8') for ind in inds]
